...
public class EncryptDecryptUtil {
    ...
    public static String encryptAes(String original, String secretKey)
        ...
        final SecretKeySpec secretKeySpec = new SecretKeySpec(secretKey.getBytes(StandardCharsets.UTF_8), ALGORITHM);
    ...
    public static String decryptAes(String encryted, String secretKey) throws InvalidAlgorithmParameterException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
